...
void quicfunc0() {
  ...
  putString(numBuffer);
  if (start !=1) putString((char *) " (counting off)");
  putString((char *) "\n");
};
...
void quicfunc1() {
  ...
  uint8ToString(numBuffer, latest_interrupted_pin);
  putString((char *) "f1p"); putString(numBuffer);putString((char *) "-P");
  uint8ToString(numBuffer, digitalPinToPort(latest_interrupted_pin));
  putString(numBuffer);
  if (start !=1) putString((char *) " (counting off)");
  putString((char *) "\n");
...
void quicfunc2() {
  ...
  showMode();
  if (start == 1) {
    putString((char *) "f2: STOP! Counting off.\n");
    putString((char *) "Interrupt OFF on tPIN1 ("); uint8ToString(numBuffer, tPIN1), putString(numBuffer);
    putString((char *) ") tPIN3 (");uint8ToString(numBuffer, tPIN3), putString(numBuffer);
    putString((char *) ") tPIN5 (");uint8ToString(numBuffer, tPIN5), putString(numBuffer);
    putString((char *) ")\n");
